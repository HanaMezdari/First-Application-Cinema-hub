...
class __TwigTemplate_b2f92018979d8678e0dc7864a48e810282ac23771efc07db80bc912be28d6527 extends Template
{
    ...
    <section class=\"form\">
        ...
        echo "
                    ...
                    ";
        // line 37
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 37, $this->source); })()), "date_de_naissance", [], "any", false, false, false, 37), 'label', ["label_attr" => ["class" => "form-label"], "label" => "Date De Naissance"]);
        echo "
                    ";
        // line 38
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 38, $this->source); })()), "date_de_naissance", [], "any", false, false, false, 38), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
...
";
    ...
    {
        return array (  166 => 44,  161 => 42,  154 => 38,  150 => 37,  145 => 35,  141 => 34,  136 => 32,  132 => 31,  126 => 28,  122 => 27,  116 => 24,  110 => 20,  104 => 17,  101 => 16,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"container\">
            ...
            <div class=\"row\">
                ...
                <div class=\"col-6\">
                    ...
                    {{ form_label(form.date_de_naissance , 'Date De Naissance', {'label_attr': {'class': 'form-label'}}) }}
...
{% endblock %}", "register/index.html.twig", "/opt/lampp/htdocs/cinema-hub/templates/register/index.html.twig");
    }
}
