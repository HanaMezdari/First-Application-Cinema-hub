...
{% for js_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_js_assets.html.twig", "/opt/lampp/htdocs/cinema-hub/vendor/easycorp/easyadmin-bundle/src/Resources/views/includes/_js_assets.html.twig");
    }
}
